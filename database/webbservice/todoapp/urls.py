...
urlpatterns = [
    ...
    url(r'^offers/$', views.OfferDetail.as_view()),
    url(r'^users/(?P<user_id>[0-9]+)/$', views.UserDetail.as_view()),
    url(r'^users/(?P<user_id>[0-9]+)/needs/$', views.ListUserNeed.as_view()),
    url(r'^users/(?P<user_id>[0-9]+)/offers/$', views.ListUserOffer.as_view()),
